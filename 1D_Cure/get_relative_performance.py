...
# Load data
with open("results/PPO-Results/output", 'rb') as file:
    ppo = pickle.load(file)
with open("results/PD-Controller/output", 'rb') as file:
    pd = pickle.load(file)
...
plt.savefig('results/PPO-Results/relative_performance.png', dpi = 500)
plt.close()