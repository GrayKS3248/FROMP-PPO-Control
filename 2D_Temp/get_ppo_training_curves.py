...
plt.plot([*range(len(data_set))],load_file['env'].loc_rate_scale*data_set)
plt.gcf().set_size_inches(8.5, 5.5)
plt.savefig(path+'/x_loc_rate_stdev.png', dpi = 500)
plt.close()
...
plt.plot([*range(len(data_set))],load_file['env'].loc_rate_scale*data_set)
plt.gcf().set_size_inches(8.5, 5.5)
plt.savefig(path+'/y_loc_rate_stdev.png', dpi = 500)
plt.close()
...
plt.plot([*range(len(data_set))],load_file['env'].mag_scale*load_file['env'].max_input_mag*data_set)
plt.gcf().set_size_inches(8.5, 5.5)
