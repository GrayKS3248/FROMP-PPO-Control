...
int load_config(int& total_trajectories, int& samples_per_trajectory, int& samples_per_batch, int& actions_per_trajectory, string& path)
{
	...
	config_file.open("../config_files/get_ae_data1.cfg");
	string config_dump;
	...
	{
		cout << "Unable to open ../config_files/get_ae_data1.cfg." << endl;
		return 1;
	}
	config_file.close();
	return 0;
...
int save_config(string path)
{
	...
	ifstream file_in;
	file_in.open("../config_files/fds1.cfg", ofstream::in);
	string read_line;
	if (file_in.is_open())
	{
	...
	file_in.open("../config_files/get_ae_data1.cfg", ofstream::in);
	if (file_in.is_open())
	{
		// Copy lines to original string
		while( getline(file_in, read_line) )
