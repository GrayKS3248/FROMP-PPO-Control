...
double get_laplacian_7(int i, int j, int k, const vector<vector<vector<double>>> &temperature, double*** fb_bc_temps, double*** tp_bc_temps);
double get_laplacian_19(int i, int j, int k, const vector<vector<vector<double>>> &temperature, double*** fb_bc_temps, double*** tp_bc_temps);
double get_laplacian_27(int i, int j, int k, const vector<vector<vector<double>>> &temperature, double*** fb_bc_temps, double*** tp_bc_temps);
