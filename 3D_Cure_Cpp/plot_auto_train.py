...
if __name__ == "__main__":
    ...
    with open('validation/DCPD_GC2_Autoencoder/0%_Cropped/1-12-16_64_Front-Shape-Seperate/output', 'rb') as file:
    ...
    plt.legend(('W/O Front Rebuilt','W/ Front Rebuilt'),loc='best',fontsize='large')
    plt.savefig('validation/DCPD_GC2_Autoencoder/0%_Cropped/autoencoder_learning_Front_Rebuilt.png', dpi = 500)
    plt.close()