...
from Speed_Estimator import Estimator
import numpy as np
import random
...
if __name__ == "__main__":
    ...
    alpha_zero = 1.0;
    alpha_last = 0.01;
    loc_est_load_path = "validation/DCPD_GC2_Estimator/Loc_Estimator"
    load_path = ""
    ...
    num_images = 5
    image_spacing = 0.10
    path = '../training_data/DCPD_GC2/Speed_Estimator'
    ...
    estimator = Estimator(loc_est_load_path, num_images, image_spacing, target_min, target_max, alpha_zero, decay_rate, load_path)
    ...
    for curr_epoch in range(num_epochs):
        ...
        for curr_batch in range(num_batches):
            ...
            states = states.reshape(samples_per_batch, num_images, estimator.location_estimator.x_dim, estimator.location_estimator.y_dim)
