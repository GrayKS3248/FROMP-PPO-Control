...
class Model(nn.Module):
    ...
    def __init__(self, dim, num_additional_inputs):
        ...
        self.fc5 = nn.Linear((self.bottleneck + self.num_additional_inputs)//2, 1)
