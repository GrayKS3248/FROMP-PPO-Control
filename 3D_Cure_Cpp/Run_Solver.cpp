...
* @return 0 on success, 1 on failure
*/
int run(Finite_Difference_Solver* FDS, PyObject* save_render_plot, int steps_per_input_cycle, int steps_per_frame, int steps_per_progress_update, auto &start_time)
{
	// Trajectory data
...
{	
	...
	double frame_rate;
	if (load_config(input_actions_per_simulation, frame_rate) == 1) { return 1; }
